...
const services = [
  {
    ...
    description:
      'Component selection, assembly, and cable management. I build your rig from scratch to meet your specific gaming or workstation needs.',
  },
  {
    icon: <Wrench className="w-8 h-8 text-purple-500" />,
    title: 'Repairs & Troubleshooting',
    description:
      'Is your PC crashing or not turning on? I diagnose hardware issues, replace broken parts, and get your system running smoothly again.',
  },
  {
    icon: <Zap className="w-8 h-8 text-yellow-500" />,
    title: 'Cleaning & Optimization',
    description:
      'Deep dust cleaning to prevent overheating, plus software optimization and virus removal to speed up your existing machine.',
  },
];
