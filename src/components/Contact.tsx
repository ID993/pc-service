...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="bg-slate-900 py-24 relative border-t border-slate-800"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 mt-4 max-w-xl mx-auto">
            Ready to build your new PC or need a fix? Send me a message and I'll
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400">ivo.damjanovic@live.com</p>
              </div>
            </div>
            ...
            <div className="p-6 bg-slate-800/50 rounded-2xl border border-slate-700 mt-8">
              <p className="text-slate-300 italic">
                "I treat every PC build as if it were my own personal machine.
                Quality and cable management are guaranteed."
              </p>
            </div>
          </div>
