...
const About = () => {
  return (
    <section
      id="about"
      className="bg-slate-800/50 py-24 relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-slate-300 text-lg mb-6 leading-relaxed">
              I started building PCs as a hobby, obsessed with getting the
              perfect cable management and optimal airflow. Now, I bring that
              same obsession to every client build.
            </p>

            <p className="text-slate-300 text-lg mb-8 leading-relaxed">
              Whether you are a competitive gamer needing zero latency or a
              creative professional needing a workstation, I build computers
              that are quiet, cool, and powerful.
            </p>
